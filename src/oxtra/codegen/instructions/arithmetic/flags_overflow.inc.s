...
overflow_add_8:
	lb t4, flag_info_overflow_value0(s11) # src1
    lb t5, flag_info_overflow_value1(s11) # src2
	slli t4, t4, 24
	slli t5, t5, 24
	...
	ret
overflow_add_16:
	lh t4, flag_info_overflow_value0(s11) # src1
	lh t5, flag_info_overflow_value1(s11) # src2
	slli t4, t4, 16
	slli t5, t5, 16
	addw t6, t4, t5 # dstw = src1 + src2 (32 bit)
	add t5, t4, t5 # dst = src1 + src2
	...
	ret
overflow_add_32:
	lw t4, flag_info_overflow_value0(s11) # src1
    lw t5, flag_info_overflow_value1(s11) # src2
    addw t6, t4, t5 # dstw = src1 + src2 (32 bit)
    add t5, t4, t5 # dst = src1 + src2
    sub t5, t5, t6 # of = (dstw != dst)
    snez t4, t5
    ret
overflow_add_64:
	ld t4, flag_info_overflow_value0(s11) # src1
	ld t5, flag_info_overflow_value1(s11) # src2
...
overflow_add_pos_8:
	lb t4, flag_info_overflow_value0(s11) # src
	lb t5, flag_info_overflow_value1(s11) # dst
	slt t4, t5, t4 # of = (dst < src) positive number added and the result is less than the operand
	ret
overflow_add_pos_16:
	lh t4, flag_info_overflow_value0(s11) # src
	lh t5, flag_info_overflow_value1(s11) # dst
	slt t4, t5, t4 # of = (dst < src) positive number added and the result is less than the operand
	ret
overflow_add_pos_32:
	lw t4, flag_info_overflow_value0(s11) # src
	lw t5, flag_info_overflow_value1(s11) # dst
	slt t4, t5, t4 # of = (dst < src) positive number added and the result is less than the operand
	ret
overflow_add_pos_64:
