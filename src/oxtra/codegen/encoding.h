...
namespace encoding {
	...
	uint32_t rtype(uint8_t opcode, uint8_t rd, uint8_t funct3, uint8_t rs1, uint8_t rs2, uint8_t funct7);

	uint32_t itype(uint8_t opcode, uint8_t rd, uint8_t funct3, uint8_t rs1, uint16_t imm);

	uint32_t stype(uint8_t opcode, uint8_t funct3, uint8_t rs1, uint8_t rs2, uint16_t imm);

	uint32_t utype(uint8_t opcode, uint8_t rd, uint32_t imm);

	uint32_t btype(uint8_t opcode, uint8_t funct3, uint8_t rs1, uint8_t rs2, uint32_t imm);

	uint32_t jtype(uint8_t opcode, uint8_t rd, uint32_t imm);
	...
	*/
	...
	riscv_instruction_t *W instructions maybe necessary

	riscv_instruction_t --- M Standard Extension --- */
	...
	*/
	...
	riscv_instruction_t nice to have: floating point
	...
	* unconditional jump
	*/
	riscv_instruction_t J(uint32_t target);
}
