...
namespace codegen {
	...
	protected:
		 ...
		 */
		void write_to_memory(CodeBatch& batch, const fadec::Operand& op, encoding::RiscVRegister src, encoding::RiscVRegister temp_a,
		...
		void update_overflow_single(CodeBatch& batch, jump_table::Entry entry, encoding::RiscVRegister va,
									encoding::RiscVRegister temp, bool set_entry) const;
